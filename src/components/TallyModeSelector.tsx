  ...
  return (
    <label className="inline-flex items-center gap-1.5 text-sm text-muted leading-none">
      ...
      <select
        ...
        className="h-9 min-h-9 min-w-38 cursor-pointer rounded-full border border-border bg-surface-2 px-3.5 pr-8 text-sm font-medium text-text outline-none transition-colors hover:border-accent/40 focus:border-accent"
